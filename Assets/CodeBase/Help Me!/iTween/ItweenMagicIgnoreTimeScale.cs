...
public class ItweenMagicIgnoreTimeScale : MonoBehaviour
{
    ...
    public void PlayUIMovement()
    {
        ...
        iTween.ValueTo(this.gameObject, iTween.Hash("delay", delayMovement, "from", GetComponent<RectTransform>().anchoredPosition, "to", targetPosition2D,
            "time", timeMovement, "ignoretimescale", ignoreTimeScale, "looptype", LoopTypeMovement.ToString(), "onupdate", "MoveGuiElement", "oncomplete", "OnMovementTweenCompleted", "easetype", EaseTypeMovement.ToString()));
    }
    ...
    public void PlayScale()
    {
        ...
        iTween.ValueTo(this.gameObject, iTween.Hash("delay", delayScale, "from", GetComponent<Transform>().localScale, "to", targetScale, "time", timeScale, "ignoretimescale", ignoreTimeScale,
